...
namespace Consultorio.MDI
{
    public partial class FrmTratamientos : Form
    {
        ...
        {
            FrmTratamientosABM FrmCABM = new FrmTratamientosABM();
            FrmCABM.ShowDialog();
            Buscar();
        }
        ...
        private void Btn_Editar_Click(object sender, EventArgs e)
        {
            try
            {
                FrmTratamientosABM FrmCABM = new FrmTratamientosABM(DG_Datos.SelectedRows[0].Tag.ToString());
        ...
        private void Btn_Eliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Datos.Tratamiento.Delete(DG_Datos.SelectedRows[0].Tag.ToString());
                    Buscar();
                }
            }
            catch (Exception Error)
